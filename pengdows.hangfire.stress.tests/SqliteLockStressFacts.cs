...
public class SqliteLockStressFacts
{
    ...
    public async Task MutualExclusion_200ConcurrentWorkers_ZeroOverlap_SqliteSingleWriter()
    {
        ...
        _out.WriteLine($"SQLite SingleWriter Stress: workers={workerCount}  acquired={acquired}  timeouts={timeouts}  violations={tracker.Violations}  maxConcurrent={tracker.GlobalMaxConcurrentOwners()}");
